...
| `formacao-complementar/` | Trilha técnica pessoal em IA e automação, módulos 00 a 29. **Só entrar quando ele chamar** ("vamos estudar a formação") e começar pelo `formacao-complementar/README.md` | Nunca misturar com a Univesp |
