...
- **A prova de 05/11 conflita com o CAO, e isso precisa de autorização.** As três provas (COM100, LET110, SOC100) caem numa terça, das 19h40 às 23h50, no polo de Valparaíso. Desde 17/08 ele é oficial-aluno do CAO-II/26 (Mestrado Profissional em Ciências Policiais), presencial no CAES, Barra Funda, até agosto de 2027, com aula de segunda a quinta e **término às 18h00 nas terças**. São 570 km entre os dois lugares: não é conveniência, é impossibilidade.
  ...
  - **Prazo real:** protocolar no SAE até o início de setembro, senão os 10 dias úteis não cabem antes de 05/11. Escolhido em 15/08 falar primeiro com o polo; se não houver encaminhamento concreto até 19/08, abrir no SAE.
